...
gene_ids <- readRDS(here("input_data/ensembl_gs_annotation.rds"))
...
SKCM_counts <- readRDS(here("input_data/SKCM_counts.rds"))
...
clinical_data <- read_csv(here("input_data/clinical_data_complete_cbioportal.csv")) |>
...
# Load mutation data
braf_mutation <- read_delim(here("input_data", "BRAF_mutations_cbioportal.txt"))
...
combined_braf <- braf_class1 |>
  ...
  left_join(
    braf_class2 |> 
      dplyr::select(sample_id, mutation_status_class2),  # Select from braf_class2
    by = "sample_id"
  )
